...
public class TableFragment extends Fragment implements TableAdapter.RecyclerViewItemOnClick {
    ...
    public void onClick(int position) {
        ...
        if(tables.get(position).getCountCurrentPeople()+customer.getCount() <= tables.get(position).getCountPeople()){
            ...
            Toast.makeText(getContext(), "Không đủ chỗ ngồi",Toast.LENGTH_SHORT).show();
        }
    }
}
